...
#[ORM\Entity(repositoryClass: AircraftManufacturerRepository::class)]
class AircraftManufacturer
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Aircraft::class, mappedBy: 'aircraftManufacturer')]
    ...
    public function addAircraft(Aircraft $aircraft): static
    {
        if (!$this->aircraft->contains($aircraft)) {
            ...
            $aircraft->setAircraftManufacturer($this);
        }
    ...
    public function removeAircraft(Aircraft $aircraft): static
    {
        if ($this->aircraft->removeElement($aircraft)) {
            ...
            if ($aircraft->getAircraftManufacturer() === $this) {
                $aircraft->setAircraftManufacturer(null);
            }
        }
