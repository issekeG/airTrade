...
class TurbineAmphibiousFloatplanesFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('hotSectionTime', NumberType::class, [
                'label' => 'Engine 1 Time Since HSI/MPI/Mid-Life (in hours)',
                'required' => false,
                'attr' => ['min' => 0],
            ])
        ...
        $builder
            ...
            ->add('hotSectionTime2', NumberType::class, [
                'label' => 'Engine 2 Time Since HSI/MPI/Mid-Life (in hours)',
                'required' => false,
                'attr' => ['min' => 0],
            ])
