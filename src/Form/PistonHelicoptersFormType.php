...
class PistonHelicoptersFormType extends AbstractType
{
        ...
        switch ($options['step']) {
            ...
            case 3:
                $builder
                    ...
                    ->add('robinsonOverhaul', ChoiceType::class, [
                        'label' => 'robinsonOverhaul',
                        'choices' => [
                            'Yes' => true,
                            'No' => false,
                        ],
                    ...
                    ->add('yearRobinsonOverhaulCompleted', ChoiceType::class, [
                        'label' => 'yearRobinsonOverhaulCompleted',
            ...
            case 5:
                $builder
                    ...
                    ->add('engineSizeUnit', ChoiceType::class, [
                        'label' => 'engineSizeUnit',
                        'choices' => [
                            'Cubic Centimeter' => 'engine cubic centimeter',
                            'Cubic Inch' => 'engine cubic inch',
                            'Liter' => 'engine liter',
                        ],
                        'required' => false,
                    ])
                    ->add('fuelControlSystem', ChoiceType::class, [
                        'label' => 'fuelControlSystem',
                        'choices' => [
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => PistonHelicoptersDto::class,
        ]);
